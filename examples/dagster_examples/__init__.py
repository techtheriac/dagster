...
def get_bay_bikes_schedules():
    from dagster_examples.bay_bikes.schedules import daily_weather_ingest_schedule, monthly_trip_ingest_schedule
...
def define_scheduler():
    return [
        *get_bay_bikes_schedules(),
        *get_toys_schedules(),
    ]


def get_toys_pipeline_info():
...
def get_airline_demo_pipeline_info():
...
def define_demo_repo():
    ...
    return RepositoryDefinition(
        ...
        pipeline_defs=[
            *get_airline_demo_pipeline_info(),
            *get_bay_bikes_pipeline_info(),
            *get_event_pipeline_info(),
            *get_jaffle_pipeline_info(),
            *get_pyspark_pipeline_info(),
            *get_toys_pipeline_info(),
        ]
    )
